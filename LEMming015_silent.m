...
%% Version 015_silent allows headless model runs
...
copyfile('LEMming015_silent.m',['./' run_filename]);
...
% Set up boundary condition mask
% boundary_E = 'WRAP';
% boundary_W = boundary_E;
% boundary_N = 'EDGEMIN';
% boundary_S = 'BOUND';
...
% Flat border
   %      topo(:,1:borderwidth) = z_bound;  % WEST
         topo(end-(borderwidth-1):end,:) = min(topo(end - borderwidth,:)); % NORTH %
